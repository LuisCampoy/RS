...
# Last revision 10/8/2024

def get_regions(filtered_df, regions_of_interest, window_size, step_size)-> list:
    '''Provides len(regions_of_interest) DataFrames with the selected regions of interest
    
    Args:
        filtered_df: pd.DataFrame provided
        regions_of_interest: list of tuples with the start and the end of each of the regions that have a standad deviation > set threshold
